...
import com.example.aphorisms.domain.usecase.GetQuotesByTagUseCase;
...
public class QuotesByTagViewModel extends ViewModel {
    private final CompositeDisposable disposables = new CompositeDisposable();
    private final GetQuotesByTagUseCase getQuotesByTag = new GetQuotesByTagUseCase();
    ...
    public void loadQuotes(String tag) {
        getQuotesByTag.execute(tag, new QuotesObserver());
    }
